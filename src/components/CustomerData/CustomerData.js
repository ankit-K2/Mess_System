...
import MontlyPlan from "./MonthlyPlan";
      ...
      <div className=" relative w-[95vw] h-[70vh]  mx-auto  bg-white ">
        ...
        <div className="flex gap-1 ">
          <div>
            <button
              onClick={handleClick}
              className={` mt-2 ml-4 p-1 bg-yellow-300 font-semibold rounded-lg wrapper 
          ...
          <div>
            <button
              onClick={handleClickGenExcel}
              className={` mt-2 ml-4 p-1 bg-yellow-300 font-semibold rounded-lg wrapper 
            ${statusGenExcel === true ? "text-white" : "text-black"}`}
            >
              {" "}
          ...
          <div>
            <button
              ...
              className={` mt-2 ml-4 p-1 bg-yellow-300 font-semibold rounded-lg wrapper 
            ${statusAddHelper === true ? "text-white" : "text-black"}`}
            >
              {" "}
              Add Helper{" "}
            </button>
        ...
        <footer className="mb-2">
          <Link
            to="/"
            className="absolute right-5 bottom-3 bg-yellow-400 px-8 py-1 border border-black outline-none rounded-sm shadow-lg "
          >
            Close
          </Link>
        </footer>
